# colour keeper
short intro to the purpose of the app 
Colour Keeper is my degree project in frontend development at Medieinstitutet, a school for higher vocational programmes.  
...
The app is fully functional. New features, such as filtering, will be added with time.  
...
## flow chart and database schema  
## screenshots  
screenshots of home, login, colors input, colors read
